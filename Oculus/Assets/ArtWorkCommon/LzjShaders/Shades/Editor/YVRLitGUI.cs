...
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class YVRLitGUI
	{
        ...
        {
			#region Extra Properity Info
			public static GUIContent receiveRectangleLitText = new GUIContent("Receive Rectangle Lit",
					"When enabled, other GameObjects can cast rectangle lit onto this GameObject.");
			#endregion
        ...
        public struct LitProperties
        {
			...
			#region Extra Properity Info
			public MaterialProperty receiveRectangleLit;
			#endregion
			// Surface Input Props
            ...
            {
				#region Extra Properity Info
				receiveRectangleLit = BaseShaderGUI.FindProperty("_ReceiveRectangleLit", properties, false);
				#endregion
				// Surface Option Props
		...
		public static void InputOthers(LitProperties properties, MaterialEditor materialEditor, Material material)
		{
			#region Extra Properity Info
			if (properties.receiveRectangleLit != null)
			{
				EditorGUI.BeginChangeCheck();
				EditorGUI.showMixedValue = properties.receiveRectangleLit.hasMixedValue;
				var receiveRectangleLit =
					EditorGUILayout.Toggle(Styles.receiveRectangleLitText, properties.receiveRectangleLit.floatValue == 1.0f);
				if (EditorGUI.EndChangeCheck())
					properties.receiveRectangleLit.floatValue = receiveRectangleLit ? 1.0f : 0.0f;
